...
let tickIcon = '<div class="icon tick"><i class="bi bi-check"></i></div>';
let crossIcon =  '<div class="icon cross"><i class="bi bi-x"></i></div>';
...
function optionSelected(answer){
    ...
    for (let i = 0; i < allOptions; i++){
        option_list.children[i].classList.add("gone");
    }
...
function showResultBox(){
    ...
    if (userScore > 3){ 
        ...
        let scoreTag = '<span>Oof! You only got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
